...
type InproxyDialParams struct {
	...
	InproxyWebrtcDtlsFingerprint                     *string                `protobuf:"bytes,92,opt,name=inproxy_webrtc_dtls_fingerprint,json=inproxyWebrtcDtlsFingerprint,proto3,oneof" json:"inproxy_webrtc_dtls_fingerprint,omitempty"`
...
func (x *InproxyDialParams) GetInproxyWebrtcDtlsFingerprint() string {
	if x != nil && x.InproxyWebrtcDtlsFingerprint != nil {
		return *x.InproxyWebrtcDtlsFingerprint
	}
	return ""
}
...
const file_ca_psiphon_psiphond_inproxy_dial_params_proto_rawDesc = "" +
	"\n" +
	"-ca.psiphon.psiphond/inproxy_dial_params.proto\x12\x13ca.psiphon.psiphond\"\xcbP\n" +
	...
	"\"inproxy_proxy_max_personal_clients\x18[ \x01(\x03HWR\x1einproxyProxyMaxPersonalClients\x88\x01\x01\x12J\n" +
	"\x1finproxy_webrtc_dtls_fingerprint\x18\\ \x01(\tHXR\x1cinproxyWebrtcDtlsFingerprint\x88\x01\x01B\x1c\n" +
	...
	"#_inproxy_proxy_max_personal_clientsB\"\n" +
	" _inproxy_webrtc_dtls_fingerprintBHZFgithub.com/Psiphon-Labs/psiphon-tunnel-core/psiphon/server/pb/psiphondb\x06proto3"
